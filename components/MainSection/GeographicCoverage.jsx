    ...
    <div className="rounded-2xl bg-[#0d0d1a] border border-white/10 p-6 flex flex-col gap-6">
      ...
      <div className="pt-4 border-t border-white/10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Link href="/#DemanderUnDevis">
          <button className="overflow-hidden rounded-none px-4 py-2 sm:px-8 sm:py-4 text-[5px] sm:text-xs tracking-[0.25em] uppercase font-semibold text-white bg-linear-to-r from-[#5226ff] to-[#e060cb] hover:opacity-90 transition-opacity duration-300 cursor-pointer whitespace-nowrap">
